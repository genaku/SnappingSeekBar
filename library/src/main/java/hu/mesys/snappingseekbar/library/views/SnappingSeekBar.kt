...
import hu.mesys.snappingseekbar.library.utils.UiUtils.getDPinPixel
import hu.mesys.snappingseekbar.library.utils.UiUtils.setColor
import hu.mesys.snappingseekbar.library.utils.UiUtils.setLeftMargin
 ...
 * Modified by Gena Kuchergin on 01.05.2020
 */
class SnappingSeekBar : RelativeLayout, OnSeekBarChangeListener {
    ...
    // Setters ------------------------------------------------------------------------------------
    // SeekBar ---------------------------------------------
    fun setSeekbarColor(seekbarColor: Int): SnappingSeekBar {
    ...
    fun setSeekBarPadding(paddingLeft: Float, paddingTop: Float, paddingRight: Float, paddingBottom: Float): SnappingSeekBar {
        seekBar?.setPadding(
    ...
    fun setSeekBarMargin(marginLeft: Float, marginTop: Float, marginRight: Float, marginBottom: Float): SnappingSeekBar {
    ...
    // Indicators ------------------------------------------
    fun setIndicatorDrawable(indicatorDrawableId: Int): SnappingSeekBar {
        this.indicatorDrawableId = indicatorDrawableId
        return this
    }

    fun setIndicatorColor(indicatorColor: Int): SnappingSeekBar {
    ...
    fun setIndicatorTextColor(indicatorTextColor: Int): SnappingSeekBar {
        this.indicatorTextColor = indicatorTextColor
        return this
    }

    fun setIndicatorTextMargin(margin: Float): SnappingSeekBar {
        return setIndicatorTextMargin(margin, margin, margin, margin)
    }

    fun setIndicatorTextMargin(marginLeft: Float, marginTop: Float, marginRight: Float, marginBottom: Float): SnappingSeekBar {
    ...
    fun setProgressBaseDrawable(progressBaseDrawable: Int): SnappingSeekBar {
    ...
    // Thumbnail --------------------------------------------
    fun setThumbDrawable(thumbDrawableId: Int): SnappingSeekBar {
    ...
    // Listener -----------------------------------------------
    fun setOnItemSelectionListener(listener: OnItemSelectionListener?): SnappingSeekBar {
